...
describe Whois::Parsers::WhoisCentralnicCom, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(DateTime.parse("2006-04-23 06:26:11 UTC"))
    end
  end
  describe "#updated_on" do
    it do
      expect(subject.updated_on).to be_a(Time)
      expect(subject.updated_on).to eq(DateTime.parse("2014-02-12 09:45:17 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(DateTime.parse("2016-04-23 23:59:59 UTC"))
    end
  end
  describe "#registrar" do
    it do
      ...
      expect(subject.registrar.name).to eq("Wind Internethaus GMBH")
